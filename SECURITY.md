...
Security fixes are provided for **currently supported release lines** of `switon/orm-codegen` (`switon/orm-codegen` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/orm-codegen/security/advisories/new)
